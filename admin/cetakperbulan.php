...
<div class="panel-heading">
							...
							<td><div align="center">
							<div align="center">
						      Laporan Data Pemesanan Ayam<br>7 Berlian Farm<br> Laporan Perbulan<br><hr>Bulan : <?php echo " $_POST[bulan]";?></div>
							 </td>
							</tr>
							</table>
</div>
...
<?php
$sql = mysql_query("SELECT * FROM orders, orderdetail, produk WHERE orders.idorder = orderdetail.idorder AND orderdetail.idproduk = produk.idproduk AND orders.tglorder LIKE '$_POST[bulan]%' order by orders.idorder asc ");
$no=1;
